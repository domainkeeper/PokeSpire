...
export const PLAYER_ACCELERATION = 6;
export const PLAYER_DECELERATION = 10;
...
export const CAMERA_LERP = 3;

export const FOG_NEAR = 20;
export const FOG_FAR = 35;

export const PLAYER_SPRITE_W = 0.7;
export const PLAYER_SPRITE_H = 1.1;
